...
export const IntroInfo: GlobalIntroInfo = {
  ...
  data: [
    {
      title: "RemitterLogin",
      content: "Authenticate an existing remitter before performing transactions"
    },
    {
...
},
{
  ...
  data: [
    ...
    },
    {
      ...
      content: "Validate beneficiary bank account details before initiating a payout"
    }
  ]
},
{
...
},
{
  ...
  content: "Receive real-time notifications for payout transaction updates",
  data: [
    {
      title: "Webhook",
      content: "Receive real-time notifications for payout transaction updates such as success, pending, or failed status. This allows your system to automatically update transaction records without repeatedly polling the API"
    }
  ]
}
  ...
  subContent: [
...

    {
      ...
      content:
        "Retrieve billing information before making a payment.",
      data: [
        {
          title: "BillFetch",
          content:
...
mobileapi: {
  mainHeading: "SOLITECK Mobile Recharge API | Digital Transformation made easy",
  ...
  subContent: [
    {
      ...
      data: [
        {
          title: "GenerateToken",
          content: "Create an access token required to authorize API requests",
        },
        {
          title: "VerifyToken",
          content:
...

    {
      ...
      data: [
        ...
        },
        {
          ...
          content:
            "Track recharge status directly within your application.",
        },
      ],
    },
  ],
