...
import ButtonLogin from "@/app/components/component/buttonLogin"
...
before:bg-[length:60px_100%]"
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {whyCards.map((card) => (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${card.bg} ${card.accent}`}
                  >
                    {card.icon}
                  </div>
        ...
        <section className="px-6 py-16">
          <div className="max-w-4xl mx-auto rounded-3xl bg-linear-to-br from-blue-600 to-blue-800 p-10 text-center text-white shadow-2xl shadow-blue-200">
            ...
            <p className="text-blue-200 mb-8 text-sm max-w-lg mx-auto">
              Start building with our sandbox environment. No credit card
              required.
            </p>
            <Link
        ...
        <footer className="border-t border-slate-200 py-8 text-center text-xs text-slate-400">
          © {new Date().getFullYear()} Soliteck Digisolutions Private Limited ·
          All rights reserved
        </footer>
      </main>
    </>
