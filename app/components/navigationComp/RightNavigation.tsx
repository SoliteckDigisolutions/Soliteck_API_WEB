              ...
              return (
                <a
                  ...
                  className={`text-[14px] transition-all   ${
                    active === id
                      ? "text-blue-600 border-t border-b bg-blue-50 p-1  font-medium border-l-3  border-blue-600 -ml-[17px] pl-4"
                      : "text-gray-600 border-t border-b bg-white p-1  font-medium border-l-3  border-gray-10 -ml-[17px] pl-4"
                  }`}
                >
                  {endpoint.title}
                </a>
