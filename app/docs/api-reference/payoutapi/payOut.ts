...
NEFT\":\"0\"}]}`,
...

    {
      ...
      notes: ["For Uat Testing:", "If you are adding from all Allbeneficiarylist For Success use RemitterNumber 9999999999", "BeneID 11113 / 11112 / 11116"],
...
API.`,
...

    {
      ...
      notes: ["For Uat Testing:", "During UAT, the delete beneficiary API will return a success response when the RemitterNumber is 9999999999 and the BeneId is either 11114 or 11111. This behavior is intended for testing purposes only."],
      request: "All headers Required",
      response: {
        success: [{
          id: 1,
