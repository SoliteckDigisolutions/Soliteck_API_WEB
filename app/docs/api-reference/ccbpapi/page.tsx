  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] px-6">
      <div className="max-w-xl w-full text-center  rounded-xl p-12  bg-white">
        ...
        {/* Title */}
        <h1 className="text-4xl font-semibold text-gray-900 mb-3">CC BP API</h1>
        ...
        <p className="text-gray-500 max-w-md mx-auto">
          Documentation for the CC BP API is currently under development. We're
          working hard to release it soon.
        </p>
      </div>
    </div>
  );
