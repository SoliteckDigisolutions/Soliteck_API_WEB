...
const headers = [
  ...
  {
    name: "ClientToken",
    desc: "Generated using GenerateToken API",
    required: true,
    generated: true,
  },
];
      ...
      <section id="authentication">
        ...
        <div className="flex items-start gap-3 px-5 py-4 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <p className="text-[13px] text-primary/80 leading-relaxed">
            Keep your <span className="font-mono text-[12px] font-medium">ClientSecret</span> and{" "}
            <span className="font-mono text-[12px] font-medium">ClientToken</span> confidential.
