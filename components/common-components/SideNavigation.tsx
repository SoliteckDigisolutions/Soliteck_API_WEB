...
import ContactCard from "@/components/common-components/ContactCard";
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[260px]  border-r bg-white h-screen sticky top-0 pt-20 px-5 overflow-y-auto hide-scrollbar">
                      ...
                      <div className="flex flex-col">
                        {hasChildren ? (
                          ...
                          <Link
                            ...
                            ${
                              active
                                ? "border-blue-200  border border-blue-200 bg-gradient-to-br from-blue-50 to-white shadow-sm text-gray-800 font-medium"
                                : "text-gray-700 hover:bg-gray-100"
                            }`}
                          >
                            <HiArrowTurnDownRight />
